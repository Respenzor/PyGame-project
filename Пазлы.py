        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.USEREVENT:
                if event.button == start_button:
                    ...
                    pygame.display.flip()
                    start_button = Settings(250, 225, 300, 100, 'Настройки музыки и звуков', BUTTON_IMAGE,
                                           BUTTON_ACTIVE_IMAGE, BUTTON_SOUND)
                    options_button = Settings(250, 355, 300, 100, 'Настройки управления', BUTTON_IMAGE,
                                             BUTTON_ACTIVE_IMAGE, BUTTON_SOUND)
                    quit_button = Settings(250, 475, 300, 100, '____', BUTTON_IMAGE, BUTTON_ACTIVE_IMAGE, BUTTON_SOUND)
                    buttons = [start_button, options_button, quit_button]
